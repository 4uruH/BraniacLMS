...
class ContactsPageView(generic.TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if self.request.user.is_authenticated:
            context["forem"] = mainapp_forms.CourseFeedbackForm(
        ...
        if self.request.user.is_authenticated:
            ...
            if not cache_lock_flag:
                ...
                messages.add_message(
                    self.request, messages.INFO, _("message send")
                )
...
class CoursesDetailView(generic.TemplateView):
...
class CourseFeedbackFormProcessView(LoginRequiredMixin, generic.CreateView):
...
class LogDownloadView(UserPassesTestMixin, generic.View):
    def test_func(self):
